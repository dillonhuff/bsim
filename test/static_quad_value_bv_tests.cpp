...
namespace bsim {
  ...
  TEST_CASE("static_quad_value vector comparison") {
    ...
    SECTION("3 bits") {
      static_quad_value_bit_vector<3> b;
      b.set(0, 1);

      SECTION("Copy construct") {
	static_quad_value_bit_vector<3> b_cpy(b);
  ...
  TEST_CASE("static_quad_value bitvector initialization") {
    SECTION("Default initialization is zero") {
      static_quad_value_bit_vector<23> a;

      REQUIRE(a.to_type<int>() == 0);
    }
    SECTION("Initializing to 5") {
      static_quad_value_bit_vector<16> a(5);
    ...
    SECTION("Default initialization is zero") {
      ...
      static_quad_value_bit_vector<30> a(i);
      static_quad_value_bit_vector<30> b = a;
    ...
    SECTION("construct from uint8") {
      bv_uint8 i = 4;
      static_quad_value_bit_vector<3> a(i);
    ...
    //   string s = "101";
    //   static_quad_value_bit_vector a(3, s);
    ...
    //   string s = "101";
    //   static_quad_value_bit_vector a(10, s);
    ...
    SECTION("Copy constructor") {
      int i = 4;
      static_quad_value_bit_vector<20> a(i);
      static_quad_value_bit_vector<20> b(a);
    ...
    SECTION("Assign from another bit vector") {
      ...
      int j = i + 12;
      static_quad_value_bit_vector<20> c(j);
    ...
    //   static_quad_value_bit_vector a("5'h3");
    //   static_quad_value_bit_vector b(5, "00011");

    //   REQUIRE(a == b);
    // }

    // SECTION("Initializing with explicit hex, ab") {
    //   static_quad_value_bit_vector a("8'hab");
    //   static_quad_value_bit_vector b(8, "10101011");

    //   REQUIRE(a == b);
    // }

    // SECTION("Initializing with explicit hex, cdef") {
    //   static_quad_value_bit_vector a("16'hcdef");
    //   static_quad_value_bit_vector b(16, "1100_1101_1110_1111");

    //   REQUIRE(a == b);
    // }

    // SECTION("Initializing with explicit hex, off width") {
    //   static_quad_value_bit_vector a("5'h18");
    //   static_quad_value_bit_vector b(5, "1_1000");
...
//       static_quad_value_bit_vector a("39'h1ca236f4c0");

//       static_quad_value_bit_vector b(a.hex_string());
...
//   }
   ...
   TEST_CASE("static_quad_value bitvector arithmetic") {

    SECTION("Setting bit vector values") {

      SECTION("Length 1 vector") {
	static_quad_value_bit_vector<1> a;
	a.set(0, 1);
	...
	static_quad_value_bit_vector<37> a;
	a.set(14, 0);
	a.set(17, 1);
	a.set(36, 1);
	a.set(2, 0);
	...
	static_quad_value_bit_vector<3> a;
	a.set(2, 1);
	
	static_quad_value_bit_vector<3> b;
	b.set(0, 1);

	static_quad_value_bit_vector<3> correct;
	correct.set(0, 1);
	correct.set(1, 1);
	...
	REQUIRE(c == correct);
      ...
      SECTION("8 bit case with overflow") {
        static_quad_value_bit_vector<8> a;
        a.set(7, 1);

        static_quad_value_bit_vector<8> b;
        b.set(7, 1);
        b.set(0, 1);

        static_quad_value_bit_vector<8> c =
          sub_general_width_bv(a, b);
...
// // 	static_quad_value_bit_vector<230> a;
// // 	a.set(220, 1);
// // 	a.set(23, 1);
// // 	a.set(3, 1);
...
// //     }
    ...
    SECTION("Unsigned multiplication") {
      ...
      SECTION("32 bit numbers") {
	static_quad_value_bit_vector<32> a;
	a.set(1, 1);
	a.set(7, 1);
	a.set(23, 1);

	static_quad_value_bit_vector<32> b;
	b.set(1, 1);
	b.set(8, 1);
	b.set(24, 1);

	static_quad_value_bit_vector<32> c =
	...
	REQUIRE(c == static_quad_value_bit_vector<32>(cn));
      }
...
//       SECTION("3 bit numbers") {
// 	static_quad_value_bit_vector a(3);
// 	a.set(0, 0);
// 	a.set(1, 1);
// 	a.set(2, 0);

// 	static_quad_value_bit_vector b(3);
// 	b.set(0, 1);
// 	b.set(1, 1);
// 	b.set(2, 0);
...
// 	static_quad_value_bit_vector expected(3);
// 	expected.set(0, 0);
// 	expected.set(1, 1);
// 	expected.set(2, 0);
...
// 	static_quad_value_bit_vector a(13);
// 	a.set(0, 0);
// 	a.set(1, 1);
// 	a.set(2, 0);
// 	a.set(12, 1);

// 	static_quad_value_bit_vector b(13);
// 	b.set(0, 1);
// 	b.set(1, 1);
// 	b.set(2, 0);
...
// 	static_quad_value_bit_vector expected(13);
// 	expected.set(0, 0);
// 	expected.set(1, 1);
// 	expected.set(2, 0);
...
//       SECTION("32 bit numbers") {
// 	static_quad_value_bit_vector a(32);
// 	a.set(23, 1);
// 	a.set(4, 1);

// 	static_quad_value_bit_vector b(32);
// 	b.set(4, 1);
// 	b.set(9, 1);

// 	static_quad_value_bit_vector c = a & b;

// 	static_quad_value_bit_vector correct(32);
// 	correct.set(4, 1);
...
//       static_quad_value_bit_vector b(33, 23);

//       REQUIRE(add_general_width_bv(a, b) == static_quad_value_bit_vector(33, 33));
//     }
...
//     	static_quad_value_bit_vector correct(3);
//     	correct.set(0, 1);
//     	correct.set(2, 1);
...
//       SECTION("1129 bits") {
//     	static_quad_value_bit_vector a(1129);
//     	a.set(1000, 1);
//     	a.set(932, 1);
//     	a.set(60, 1);

//     	static_quad_value_bit_vector b(1129);
//     	b.set(1001, 1);
//     	b.set(932, 1);
//     	b.set(287, 1);
...
//     	static_quad_value_bit_vector correct(1129);
//     	correct.set(1001, 1);
//     	correct.set(1000, 1);
//     	correct.set(932, 1);
//     	correct.set(287, 1);
...
//     	static_quad_value_bit_vector a(83);
//     	a.set(82, 1);
//     	a.set(60, 1);
//     	a.set(13, 1);

//     	static_quad_value_bit_vector b(83);
//     	b.set(60, 1);

//     	static_quad_value_bit_vector c = a ^ b;

//     	static_quad_value_bit_vector correct(83);
//     	correct.set(82, 1);
//     	correct.set(13, 1);
...
//       SECTION("77 bits") {
//     	static_quad_value_bit_vector a(77);
//     	a.set(49, 1);
//     	a.set(12, 1);

//     	static_quad_value_bit_vector c = ~a;

//     	static_quad_value_bit_vector correct(77);
//     	for (int i = 0; i < 77; i++) {
//     	  if ((i != 49) && (i != 12)) {
//     	    correct.set(i, 1);
//     	  }
...
// 	static_quad_value_bit_vector a(23, "01010010101010101111001");
// 	static_quad_value_bit_vector b(23, "01010010101010101111001");
// 	static_quad_value_bit_vector c(23, "11010010101110101111001");
...
// 	static_quad_value_bit_vector a(7, "0101000");
// 	static_quad_value_bit_vector b(7, "1101000");

// 	REQUIRE(b > a);
//       }

//       SECTION("9 bit numbers") {
// 	static_quad_value_bit_vector a(9, "100101010");
// 	static_quad_value_bit_vector b(9, "100101000");
...
// 	static_quad_value_bit_vector a(17, "01001011110101010");
// 	static_quad_value_bit_vector b(17, "10001001101010011");
...
//       b_ext = shl(b_ext, static_quad_value_bit_vector(10, 3));
